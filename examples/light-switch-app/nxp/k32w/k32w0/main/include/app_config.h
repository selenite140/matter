...
#define LIGHT_SWITCH_BUTTON 2
#define OTA_BUTTON 3
#define BLE_BUTTON 4

#define RESET_BUTTON_PUSH 1
#define LIGHT_SWITCH_ONOFF_BUTTON_PUSH 2
#define LIGHT_SWITCH_DIMMER_BUTTON_PUSH 3
#define GENERIC_SWITCH_BUTTON_PUSH 4
#define OTA_BUTTON_PUSH 5
#define BLE_BUTTON_PUSH 6

#define APP_BUTTON_PUSH 1

#define SYSTEM_STATE_LED LED2
#define LIGHT_SWITCH_STATE_LED LED1
