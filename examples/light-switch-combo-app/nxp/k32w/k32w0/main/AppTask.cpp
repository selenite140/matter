...
void AppTask::UpdateClusterStateInternal(intptr_t arg)
{
    ...
    EmberAfStatus status =
        emberAfWriteAttribute(2, ZCL_ON_OFF_CLUSTER_ID, ZCL_ON_OFF_ATTRIBUTE_ID, (uint8_t *) &newValue, ZCL_BOOLEAN_ATTRIBUTE_TYPE);
...
void AppTask::UpdateDeviceStateInternal(intptr_t arg)
{
    ...
    (void) emberAfReadAttribute(2, ZCL_ON_OFF_CLUSTER_ID, ZCL_ON_OFF_ATTRIBUTE_ID, (uint8_t *) &onoffAttrValue, 1);
